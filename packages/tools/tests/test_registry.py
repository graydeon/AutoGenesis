...
class TestToolRegistry:
    ...
    def test_usage_frequency_priority(self):
        ...
        # Should prioritize often_used due to budget
        names = [d.name for d in defs]
    ...
    def test_tier_filtering(self):
        ...
        class PremiumTool(FakeTool):
            @property
            def tier_requirement(self) -> ModelTier:
                return ModelTier.PREMIUM

        registry.register(FakeTool("basic"))
        registry.register(PremiumTool("premium_only"))
        ...
        assert "premium_only" not in names
